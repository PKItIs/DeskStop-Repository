...
left_frame = Frame(root,bd=2,bg='white',padx=10,pady=10)
Label(left_frame,text="Enter Username",bg='white').grid(row=0, column=0, sticky=W, pady=10)

Label(left_frame,text="Enter Password",bg='white').grid(row=1, column=0, pady=10)
...
def openNewWindow():
    #get the userr mail id and password and check with a predefined if condition and create a new window
