...
Label(left_frame, text="Enter username:", bg="white").grid(row=0, column=0, pady=5)
Label(left_frame, text="Enter password:", bg="white").grid(row=1, column=0, pady=5)
...
def openNewWindow():
    ...
    if user_name == 'Demo123' and user_pass == '123':
        newWindow = Toplevel(root)
        newWindow.title("Transaction details")
